...
| `plans/011-float-wake-ramp.md` | MEDIUM | physicality | **DONE (2026-08)** — smoothstep wake-in, first live tick writes y=0 (see execution log) |
| `plans/012-focus-damps-levitation.md` | MEDIUM | cohesion | **DONE (2026-08)** — `isFocusMode()` + delta-scaled damp to 20% (see execution log) |
| `plans/013-motion-prefs-single-source.md` | LOW | cohesion/a11y | **DONE (2026-08)** — one `src/utils/motion-prefs.js` with a live listener, all seven consts deleted (see execution log) |
